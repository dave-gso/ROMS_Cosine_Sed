...
**
** svn $Id: cppdefs.h 778 2015-08-22 01:20:04Z arango $
********************************************************** Hernan G. Arango ***
...
** BIO_UMAINE13          use if UMAINE CoSiNE 13 model                       **
** BIO_UMAINE15          use if UMAINE CoSiNE 15 model                       **
** BIOSED                use to turn on sediment biology for UMAINE CoSiNE15 **
** BIO_UMAINE31          use if UMAINE CoSiNE 31 model                       **
